...
`commit auditado:` `00dca9b2e8de` · `protocolo:` 1.0 · `data:` 2026-09-12T19:02:12+0000
...
```
```bash
python 05_Interface_Auditoria/scripts/auditar_proposta.py 05_Interface_Auditoria/propostas/PRP-0005-step-land-10-chanfro-080.json
```
</details>

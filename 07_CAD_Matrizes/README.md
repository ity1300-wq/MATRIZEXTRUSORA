...
| `Matriz_Jonatha_v29_OFICIAL/` | a v27.0 como peça única (sem Bipartição, sem pino, sem junta), com o pacote de usinagem apontando para cá | `MATRIZ_V29_PECA_UNICA.step`, `MATRIZ_V29_CANAL_DE_FLUXO.step`, `CONJUNTO_MATRIZ_V29_NO_CABECOTE_EX-030.step`, `README.md` |
| `Matriz_Jonatha_v30_OFICIAL/` | **a master vigente desde 2026-09-22** (SSOT `matriz_oficial` = v30.0) — mesmas cotas da v29 re-feita com o comprimento encurtado para 95,00 mm: face de saída faceada com o nariz do EX-030, funil comprimido em Z e land/chanfro/fenda movidos rigidamente (inalterados) | `MATRIZ_V30_PECA_UNICA.step`, `MATRIZ_V30_CANAL_DE_FLUXO.step`, `CONJUNTO_MATRIZ_V30_NO_CABECOTE_EX-030.step`, `README.md` |

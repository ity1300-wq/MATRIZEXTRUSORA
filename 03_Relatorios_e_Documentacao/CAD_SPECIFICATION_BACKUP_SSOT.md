...
- **Modelo Principal Master Oficial**: `07_CAD_Matrizes/M01_Jonatha_v27_OFICIAL/MatrizJonatha.step` (Volume do Bloco A = $234.255,29\text{ mm}^3$, Bloco B = $234.746,37\text{ mm}^3$).
...
| :--- | :--- | :--- |
| **Caminho do Arquivo STEP** | `02_CAD_Modelos_Historicos/MatrizGedeon.step` | **`07_CAD_Matrizes/M01_Jonatha_v27_OFICIAL/MatrizJonatha.step`** |
...
- **`07_CAD_Matrizes/M01_Jonatha_v27_OFICIAL/MatrizJonatha.step`** (Montagem usinada oca bipartida AP214)
- **`07_CAD_Matrizes/M01_Jonatha_v27_OFICIAL/MatrizJonatha_Explodida.step`** (Vista explodida +40mm Y)
- **`07_CAD_Matrizes/M01_Jonatha_v27_OFICIAL/MatrizJonatha_Com_Fluxo.step`** (Montagem com núcleo de polímero)
- **`07_CAD_Matrizes/M01_Jonatha_v27_OFICIAL/MatrizJonatha_Body_A.step`** & **`Body_B.step`** (Sólidos isolados A e B)
- **`07_CAD_Matrizes/M01_Jonatha_v27_OFICIAL/MatrizJonatha_Canal_Fluxo.step`** (Macho do canal de polímero)

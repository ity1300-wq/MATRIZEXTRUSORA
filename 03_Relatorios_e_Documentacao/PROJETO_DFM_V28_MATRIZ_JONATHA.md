...
v28.1 vive ao lado, com `verificar_v28.py` (64 itens) e `verificar_interface_cabecote.py` (49 itens, 41 conformes, 1 não conforme — a folga axial dos cartuchos × a luva do nariz, que é a linha 'medir' acima)

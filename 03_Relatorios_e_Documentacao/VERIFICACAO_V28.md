# Verificação exata da revisão v28.0 — Matriz Jonatha
...
| Land reto e paralelo (v27.0: 8,50) | 9,2 | 9,2 | ✅ | P8 resolvido no modelo |
| Chanfro de saída (v27.0: 1,50) | 0,8 | 0,8 | ✅ | P7: lâmina mais robusta |
| Sobrelargura do chanfro a 0,10 mm da face | 0,7 | 0,702 | ✅ | chanfro de 45° |
| Lâmina de aço no lábio de saída (v27.0: 0,75) | — | 1,450 mm | ✅ | P7 resolvido: ≥ 1,40 mm era o critério |
...
| parede mínima até o canal - cartucho X=+22.00 Z=97.00 | — | 9,324 mm | ✅ | alvo ≥ 4,00 mm | invadiu o canal em 0,000000 mm³ |
|   ∩ volume do canal - cartucho X=+22.00 Z=97.00 | — | 0,000000 mm³ | ✅ | zero = o furo não comunica com o fluxo |
| parede mínima até o canal - termopar X=-11.00 Z=103.00 | — | 17,033 mm | ✅ | alvo ≥ 3,00 mm | invadiu o canal em 0,000000 mm³ |
...
| Massa de aço (7,85 g/cm³) | — | 3,587 kg | ✅ | v27.0: 3,682 kg | aços: P20 pré / H13 temperado |
| Área projetada do canal no plano XZ (medida) | — | 8168 mm² | ✅ | é a área sobre a qual a pressão empurra as metades uma contra a outra |
...
| ΔP 1D - lei das potências (método do próprio projeto) | — | v28.0 = 43,9 bar | v27.0 = 41,9 bar | ✅ | land 9,20 vs 8,50 paralelos → +2.0 bar; maior gradiente em Z≈99,2 mm |
...
| Cotas de usinagem do land | — | paralelo Z=99,00→108,20 mm (9,20) · chanfro 0,80×45° Z=108,20→109,00 mm | ✅ | conferir no desenho antes de cortar o aço |

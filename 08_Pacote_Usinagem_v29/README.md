...
## Como conferir o pacote antes de enviar
    ...
    cd 08_Pacote_Usinagem_v29 && sha256sum -c CHECKSUMS_SHA256.txt   # os caminhos do arquivo sao relativos a esta pasta
...
`PACOTE_MATRIZ_V29_PARA_ENVIO.zip` (594 KB) — mesmo conteúdo da pasta, para anexar. sha256 do zip:
`74053b229e21cc4e...` (confira antes de abrir; se a fábrica receber por e-mail, o sha é o que prova que o anexo é este).

...
| arquivo | o que é |
| :--- | :--- |
| `06_CAD_Cabecote_EX-030/STEP/estudos/Cabecote_EX-030_sem_flange_M12.step` | **o pedido**: corpo Ø130 × 95,000 mm com o nariz Ø80, o degrau Ø90 e o bolso Ø95 × 71,000 mm |
| `06_CAD_Cabecote_EX-030/STEP/estudos/Cabecote_EX-030_desenhado_M12.step` | o cabeçote como está no desenho (cubo + flange + resalto), para referência e para a subtração |
...
* volume 1662551 → 620465 mm³; massa **13,051 → 4,871 kg**, foram **8,180 kg** de aço a menos (62,7 % do volume) — a conta do material e do tempo de usinagem muda de verdade;
...
* na parede do bolso (entre a banda Ø93 e o furo Ø95): 0,225 mm³ removidos pelo corte — o Ø12 do M12, se ele for transversal, abre 1,00 mm além da banda da matriz, na parede onde o collete EX-031 encosta, e não na matriz;

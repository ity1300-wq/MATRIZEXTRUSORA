...
- `STEP/Cabecote_EX-030_com_Matriz_Copo.step` e `STEP/Cabecote_EX-030_com_Matriz_Gedeon.step` — o cabeçote
  **com a matriz sentada**, um arquivo composto com 2 sólidos no mesmo referencial axial (sem booleano, para
  a folga ser medida no CAD de quem recebe). Interferência medida nos dois: **0,0000 mm³**. Saída da matriz em
  Z = 80,70 (Copo, 14,30 mm *para dentro* da face do nariz) e Z = 109,00 (Gedeon, 14,00 mm *para fora*) — é a
  diferença que você viu na máquina, e ela é só comprimento de peça: falta na Copo o nariz de 28,30 mm.

# E-mail de primeiro contato — capa do pacote (não vai no zip)
    ...
    **Assunto:** Cotação — 1 matriz de extrusão em aço 1045 · fenda 1,50 mm aberta a fio EDM · indução no land
    ...
    Resumo do que é: Ø94,00 × 95,00 mm em **aço 1045**, sem flange e sem furo de fixação (segura por collete
    ...
    Anexo: `PACOTE_MATRIZ_V30_PARA_ENVIO.zip` — **sha256 do anexo: `0ed4642069255a0c908cbd1b7e37214be56ee1566dc30a896388c3da43cbc70e`** (622460 bytes). Se o hash não bater, não abram: peça reenvio.

# O que o STEP não diz (e precisa estar na ordem de serviço)

* **Datum.** O datum A é o cilindro do 1º estágio (Ø94,00, Z 0,00 → 69,90), não a face de entrada; a face de
...
* **Sem furo de partida** na boca de entrada: o arame entra pelo Ø75,60 já aberto; se a fábrica
